...
export const contactFaqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Personeelsaanvragen: planning@helpinghandsagency.nl. Crewaanmeldingen en sollicitaties: aanmeldingen@helpinghandsagency.nl (H&R: marieke@helpinghandsagency.nl). Algemene vragen: info@helpinghandsagency.nl. Mede-eigenaar: sieb@helpinghandsagency.nl.",
  },
  {
