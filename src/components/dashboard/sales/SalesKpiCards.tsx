...
import type { SalesKpi } from "@/data/salesMockData";

const iconMap: Record<SalesKpi["icon"], LucideIcon> = {
  leads: Users,
  offers: FileText,
  won: Handshake,
  pipeline: Target,
...
export default function SalesKpiCards({ cards }: SalesKpiCardsProps) {
  return (
