...
import { CLIENT_INTEGRATIONS } from "@/lib/clientPortal";
...
export default function ClientIntegrationStatus() {
  ...
  async function checkAll() {
    ...
    for (const item of CLIENT_INTEGRATIONS) {
      if (!item.checkUrl) {
