...
import { urenSteps } from "@/lib/opdrachtgeversContent";

export default function UrenRegistratieSection() {
  return (
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <ol className="relative mx-auto mt-12 max-w-3xl space-y-4">
          <div
            ...
            aria-hidden="true"
          />
          {urenSteps.map((step, index) => (
            <RevealOnScroll key={step.step} delayMs={index * 60}>
