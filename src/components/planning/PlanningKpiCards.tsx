...
import type { PlanningKpi } from "@/data/planningMockData";

const iconMap: Record<PlanningKpi["icon"], LucideIcon> = {
  shifts: CalendarDays,
  crew: Users,
  open: AlertCircle,
  hours: Clock,
...
type PlanningKpiCardsProps = {
  cards: PlanningKpi[];
};

export default function PlanningKpiCards({ cards }: PlanningKpiCardsProps) {
  return (
