          ...
          <div className="grid grid-cols-2 gap-3">
            {heroCards.map((card, index) => (
              <div
                key={card.label}
                className={cn(
                  "relative overflow-hidden rounded-2xl p-5 shadow-xl ring-1 ring-white/15",
                  card.tone,
              ...
              >
                ...
                <p className="mt-2 text-xl font-black">{card.label}</p>
                <p className="mt-1 text-sm text-white/75">{card.hint}</p>
              </div>
            ))}
          </div>

          <div className="mt-3 rounded-2xl border border-white/20 bg-[#0B1F4D]/90 p-4 shadow-xl backdrop-blur-md sm:absolute sm:-bottom-2 sm:left-4 sm:right-4 sm:mt-0">
            <p className="text-xs font-bold uppercase tracking-[0.16em] text-[#F28C28]">
              Planning klaar
            </p>
            <ul className="mt-2 grid gap-1.5 text-sm font-semibold text-white/90 sm:grid-cols-3">
              <li>Briefing ontvangen</li>
              <li>Locatie bekend</li>
              <li>Team op locatie</li>
            </ul>
          </div>
        </div>
      </div>
