...
export const openActions: OpenAction[] = [
  {
    id: "1",
    actie: "Crew zoeken voor festivalterrein",
    eigenaar: "Demo Planner",
    deadline: "Vandaag",
    status: "Bezig",
  },
  {
    id: "2",
    actie: "Offerte opvolgen Demo Klant 1",
    eigenaar: "Demo Sales",
    deadline: "Morgen",
    status: "Follow-up",
  },
  ...
  },
  {
    ...
    eigenaar: "Demo Finance",
    deadline: "3 juli",
    status: "Wachten",
  },
  {
    id: "5",
    actie: "Marketingcampagne Q3",
    eigenaar: "Demo Sales",
    deadline: "5 juli",
    status: "Bezig",
  },
...
export const dashboardNotifications: DashboardNotification[] = [
  {
    ...
    description: "Demo Klant 2 — 8 bedieningsmedewerkers gevraagd",
    time: "12 min geleden",
    type: "lead",
  },
  {
    ...
    description: "Festivalterrein is nu actief",
    time: "45 min geleden",
    type: "project",
  },
  {
    ...
    description: "Factuur HH-041 — €2.850 ontvangen",
    time: "2 uur geleden",
    type: "invoice",
  },
  {
    ...
    description: "Demo Crew 3 — bediening & runner",
    time: "3 uur geleden",
    type: "crew",
  },
  {
    ...
    description: "Demo Klant 1 — 12 crew voor load-out",
    time: "5 uur geleden",
    type: "request",
  },
];
